...
describe('JapiTableBody', () => {
  describe('getValueOfKeyPath', () => {
    describe('when relationship does not exist', () => {
      it('warns and returns nothing', () => {
        const body = new JapiTableBody();
        console.warn = jest.genMockFn();
        expect(body.getValueOfKeyPath(['one', 'two'], {relationships: {}})).toBeUndefined();
        expect(console.warn).toBeCalled();
        expect(console.warn.mock.calls[0][1]).toEqual('one');
      });
    });
  });
